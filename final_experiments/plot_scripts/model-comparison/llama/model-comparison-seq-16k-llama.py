...
ulysses = np.array([1.42, 3.79, 8.15])
ulysses_all_all_percent = np.array([28, 35.4, 33.5])

basp = np.array([1.21, 3.01, 6.73])
basp_all_all_percent = np.array([13.4, 18.6, 16.5])
...
plt.tight_layout()
plt.savefig("model-comparison-seq-16k-llama.pdf")